  ...
  return (
    <section className="bg-zinc-50 py-8 md:py-16 dark:bg-transparent">
      <div className="mx-auto w-full max-w-5xl px-6 pb-12">
        <div>
          <h2 className="text-foreground max-w-2xl text-4xl font-semibold text-balance">
      ...
      <div className="mx-auto max-w-2xl px-6 lg:max-w-5xl">
        <div className="mx-auto grid gap-4 lg:grid-cols-2">
          ...
          <FeatureCard className="p-4 lg:col-span-2">
            <p className="mx-auto my-4 max-w-md text-center text-2xl font-semibold text-balance">
