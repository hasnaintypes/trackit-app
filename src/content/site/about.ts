...
export const hero: AboutHero = {
  ...
  description:
    "Cashio helps you track spending, automate budgets with smart AI, and settle group expenses quicklysecurely and collaboratively.",
  image:
  ...
  items: [
    {
      label: "Active Users",
      value: "25k+",
      description: "Individuals and teams managing their finances with Cashio.",
    },
    {
...
export const faq: FAQSectionContent = {
  ...
  items: [
    {
      question: "How does Cashio ensure my financial data is secure?",
      answer:
    ...
    },
    {
      ...
      answer:
        "Cashio uses AI (powered by Gemini/OpenAI) for several features: Predictive Modeling for future bills and savings gaps, Anomaly Detection for unusual spending, and intelligent categorization. It also provides Monthly/Weekly AI Spending Summaries and identifies your top savings opportunities.",
    },
    {
      question:
        "Can I use Cashio to manage shared expenses with friends or family?",
      answer:
    ...
    {
      question: "How does Cashio handle receipts and data entry?",
      answer:
